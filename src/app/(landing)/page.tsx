...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#050508] text-slate-100 font-sans overflow-x-hidden">
      {/* ===== Top Banner ===== */}
      <div className="border-b border-emerald-900/20 bg-gradient-to-r from-emerald-950/30 via-transparent to-emerald-950/30 text-center text-sm py-2.5 px-4">
        <span className="text-emerald-300/70">
          ⚡️ ¿Buscas alertas en tiempo real de Crypto, TRM, SECOP o Caídas Web?{" "}
        </span>
        <Link href="/alertas" className="text-emerald-400 font-semibold hover:text-emerald-300 transition-colors">
      ...
      <nav className="sticky top-0 z-50 border-b border-slate-800/50 bg-[#050508]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 h-14">
          <Link href="/" className="font-extrabold text-lg tracking-tight">
            WASAPEA<span className="text-emerald-500">PRO</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/join" className="text-sm px-4 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-medium transition-colors">
              Empezar gratis
            </Link>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/5 text-emerald-300 text-xs font-medium mb-6">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.08] mb-6">
                WhatsApp{" "}
                <span className="bg-gradient-to-r from-emerald-300 via-emerald-400 to-emerald-400 bg-clip-text text-transparent">
                  profesional
                </span>
                <br />
                sin complicaciones
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className="group p-6 rounded-2xl border border-slate-800/50 bg-slate-900/30 hover:bg-slate-900/50 hover:border-slate-700/50 transition-all">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/10 flex items-center justify-center text-xl mb-4 group-hover:scale-110 transition-transform">
                  {f.icon}
                </div>
      ...
      <section className="py-20 border-t border-slate-800/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="relative rounded-3xl border border-emerald-500/15 bg-gradient-to-br from-emerald-950/20 to-emerald-950/10 p-10 sm:p-16 overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-40 bg-emerald-500/8 rounded-full blur-3xl" />
...
function MockupWindow() {
  return (
    <div className="relative select-none">
      {/* Glow behind mockup */}
      <div className="absolute -inset-4 bg-gradient-to-br from-emerald-500/15 via-emerald-500/5 to-transparent rounded-3xl blur-xl" />
        ...
        <div className="flex h-[340px] sm:h-[380px]">
          ...
          <div className="w-[36%] border-r border-slate-800 flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
              {[
                ...
                <div key={c.name} className={`px-3 py-2.5 border-b border-slate-800/50 flex items-start gap-2.5 ${c.active ? "bg-emerald-500/8 border-l-2 border-l-emerald-400" : "hover:bg-slate-800/30"}`}>
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-500 flex-shrink-0 flex items-center justify-center text-xs font-bold">
                    {c.name[0]}
                  </div>
          ...
          <div className="flex-1 flex flex-col bg-slate-950/50">
            ...
            <div className="px-4 py-2.5 border-b border-slate-800 flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-500 flex items-center justify-center text-[10px] font-bold">
                M
              </div>
              <div>
            ...
            <div className="flex-1 p-4 space-y-4 overflow-hidden">
              ...
              <div className="flex items-start gap-2">
                <div className="w-6 h-6 rounded-full bg-emerald-600 flex-shrink-0 flex items-center justify-center text-[10px]">W</div>
                <div>
                  <div className="bg-emerald-500/10 border border-emerald-500/15 rounded-2xl rounded-tl-sm px-3 py-2 text-[11px] text-slate-300 max-w-[200px]">
